...
PARAMS_Z500_1in1out_24h_seasonal_cycle = {
    ...
    'savefig_params': {
        'fname' : '/home/disk/brume/nacc/gradient_dissent/DLESyM/scratch/24h_2in2out_full_eval/forecast_seasonal_cycle_z500_2in2out_24h.png',
        'dpi' : 300,
    },
...
PARAMS_Z500_1in1out_24h_NH_40yr_blocking = {
    ...
    'output_dir' : '/home/disk/brume/nacc/gradient_dissent/DLESyM/scratch/24h_2in2out_full_eval/',
...
params_nam_24hr = dict(
        ...
        mode = 'NAM',
        output_cache = '/home/disk/brume/nacc/gradient_dissent/DLESyM/scratch/24h_2in2out_full_eval/2in2out24hr_cache_nam.nc',
        output_plot_file =  '/home/disk/brume/nacc/gradient_dissent/DLESyM/scratch/24h_2in2out_full_eval/2in2out24hr_map_nam.png'
...
params_sam_24hr = dict(
        ...
        mode = 'SAM',
        output_cache = '/home/disk/brume/nacc/gradient_dissent/DLESyM/scratch/24h_2in2out_full_eval/2in2out24hr_cache_sam.nc',
        output_plot_file = '/home/disk/brume/nacc/gradient_dissent/DLESyM/scratch/24h_2in2out_full_eval/2in2out24hr_map_sam.png'
    )
tc_params_24h = dict(
        ...
        output_prefix = '/home/disk/rhodium/nacc/gradient_dissent/DLESyM/scratch/24h_2in2out_full_eval/2in2out24hr_TC-eval',
    )
