...
PARAMS_Z500_1in1out_12h_seasonal_cycle = {
    # forecast file 
    'forecast_file': '/home/disk/rhodium/nacc/forecasts/hpx64_coupled-dlwp-olr_1-to-1_seed0_12h-AR+hpx64_coupled-dlom-olr_unet_dil-112_double_restart/atmos_100-year_JanInit.nc',
    ...
    'savefig_params': {
        'fname' : '/home/disk/brume/nacc/gradient_dissent/DLESyM/scratch/12h_1in1out_full_eval/forecast_seasonal_cycle_z500_1in1out_12h.png',
        'dpi' : 300,
    },
    'verif_title':'6-year ERA5 Seasonal Cycle',
}
PARAMS_Z500_1in1out_12h_NH_40yr = {
    'forecast_file' : '/home/disk/rhodium/nacc/forecasts/hpx64_coupled-dlwp-olr_1-to-1_seed0_12h-AR+hpx64_coupled-dlom-olr_unet_dil-112_double_restart/atmos_100-year_JanInit',
    ...
    'output_dir' : '/home/disk/brume/nacc/gradient_dissent/DLESyM/scratch/12h_1in1out_full_eval/',
...
params_nam_12hr = dict(
        ...
        mode = 'NAM',
        output_cache = '/home/disk/brume/nacc/gradient_dissent/DLESyM/scratch/12h_1in1out_full_eval/1in1out12hr_cache_nam.nc',
        output_plot_file = '/home/disk/brume/nacc/gradient_dissent/DLESyM/scratch/12h_1in1out_full_eval/1in1out12hr_map_nam.png'
...
params_sam_12hr = dict(
        ...
        mode = 'SAM',
        output_cache = '/home/disk/brume/nacc/gradient_dissent/DLESyM/scratch/12h_1in1out_full_eval/1in1out12hr_cache_sam.nc',
        output_plot_file = '/home/disk/brume/nacc/gradient_dissent/DLESyM/scratch/12h_1in1out_full_eval/1in1out12hr_map_sam.png'
    )
tc_params_12h = dict(
        # directory of input file
        input_dir = '/home/disk/rhodium/nacc/forecasts/hpx64_coupled-dlwp-olr_1-to-1_seed0_12h-AR+hpx64_coupled-dlom-olr_unet_dil-112_double_restart/',
        # name of z1000 file
        ...
        output_prefix = '/home/disk/brume/nacc/gradient_dissent/DLESyM/scratch/12h_1in1out_full_eval/1in1out12hr_TC-eval',
    )
...
if __name__ == "__main__":
    ...
    if run_seasonal_cycle:
        ...
        seasonal_cycle_main(PARAMS_Z500_1in1out_12h_seasonal_cycle)
    if run_blocking:
        from evaluation.blocking import blocking_frequency
        blocking_frequency(**PARAMS_Z500_1in1out_12h_NH_40yr)
    if run_tc:
        from evaluation.TC_freq_hpx import main as tc_main
        tc_main(**tc_params_12h)
    if run_nam:
