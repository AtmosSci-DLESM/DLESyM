...
OUTPUT_FILE="${OUTPUT_DIR}/forced_forecasts_1978-2025_5member.out"
# Path to models 
...
do
    RUN_CMD="python scripts/coupled_forecast_hdf5.py \
        ...
        --atmos-output-filename atmos_aimip_forced_forecast_1978-2025_n${ATMOS_OUTPUT_FILENAME_SUFFIXES[$i]} \
        --ocean-output-filename ocean_aimip_forcing_1978-2025_n${OCEAN_OUTPUT_FILENAME_SUFFIXES[$i]} \
