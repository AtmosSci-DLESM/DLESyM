...
EXP_NAME="hpx32_dlom_sst-only_48H-dt_256-128-64_basic-conv"
...
RUN_CMD="python -u scripts/train.py num_workers=4 port=4550 learning_rate=2e-4 batch_size=16 experiment_name=${EXP_NAME} model=hpx32_dlom_sst-only_48H-dt model.encoder.n_channels=[256,128,64] model.decoder.n_channels=[64,128,256] trainer.max_epochs=100 trainer/criterion=ocean_mse data=hpx32_dlom_sst-only_48H-dt trainer/lr_scheduler=cosine trainer/optimizer=adam model.enable_healpixpad=True"
