...
def inference(args: argparse.Namespace):
    ...
    optional_kwargs = {k: v for k, v in {
        ...
        'dst_directory': args.destination_directory,
        'dataset_name': args.data_name,
        'prebuilt_dataset': args.prebuilt
...
if __name__ == '__main__':
    ...
    parser.add_argument('--destination-directory', type=str, default=None,
                        help='Destination directory if different from training data')
    parser.add_argument('--data-name', type=str, default=None,
                        help='Name of zarr file')
    parser.add_argument('--prebuilt', type=bool, default=None,
                        help='set to false if test data != train data')
